    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        <section class="panel default blue_title h2">
              ...
              <form method="POST" action="{{route('buscarClientes1')}}">
                {{csrf_field()}}
              ...
              <div class="panel-heading center">
                ...
                <div class="panel-body">
                  <div class="col-md-12 default">
                    ...
                    <div class="col-md-6">
                      <form action="{{URL::action('PDFController@ClientesPDF', ['criterio'=>$criterio])}}" method="get">
                    ...
                    <div class="col-md-6">
                      <form action="{{URL::action('ExcelController@ClientesExcel', ['criterio'=>$criterio])}}" method="get">
