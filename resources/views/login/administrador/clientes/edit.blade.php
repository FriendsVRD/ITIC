        ...
        <div class="row">
          <div class="col-sm-12 col-sm-12">
             <div class="col-md-12">
                <div class="block-web">
                  <div class="header">
                    <h3 class="content-header">Modificar Cliente</h3>
                  </div>
                  <div class="porlets-content">
                    <form class="form-horizontal group-border-dashed" action="{{route('modificar_cliente1')}}" parsley-validate novalidate method="POST">
                      {{csrf_field()}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="hidden"
                                  class="form-control" 
                                  required placeholder="Escribir Nombre" 
                                  name="id_cliente"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text"
                                  class="form-control"
                                  required placeholder="Escribir Apellido Paterno" 
                                  name="ap_cliente"
                                  value="{{$clientes->ap_cliente}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text"
                                class="form-control" 
                                required placeholder="Escribir Apellido Materno"
                                name="am_cliente"
                                value="{{$clientes->am_cliente}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" 
                                class="form-control"
                                required placeholder="Escribir Dirección"
                                name="direccion_cliente"
                                value="{{$clientes->direccion_cliente}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input parsley-type="phone"
                                  ...
                                  value="{{$clientes->telefono_cliente}}">
                        </div>
                      </div><!--/form-group-->
