    ...
    <!--\\\\\\\ inner start \\\\\\--><div class="left_nav">
      ...
      <div class="left_nav_slidebar">
        <ul>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> AVISOS <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul>
              <li> <a href="Avisos"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Detalles</b> </a> </li>
              <li> <a href="AltaAviso"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Nuevo Avios</b> </a> </li>
            </ul>
          </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        <section class="panel default blue_title h2">
              ...
              <form method="POST" action="{{route('buscarAlimentos1')}}">
                {{csrf_field()}}
                ...
                <div class="container">
                  <div class="card" style="width: 250px;">
                    ...
                    <div class="card-body">
                      ...
                      <br>
                      <a href="{{URL::action('AlimentosController@edit1',['id_aliment'=>$alimento->id_alimento])}}" class="btn btn-outline-warning btn-block">Modificar</a>
              ...
              <div class="panel-heading center">
                ...
                <div class="panel-body">
                  <div class="col-md-12 default">
                    ...
                    <div class="col-md-6">
                      <form action="{{URL::action('PDFController@AlimentosPDF', ['criterio'=>$criterio])}}" method="get">
                    ...
                    <div class="col-md-6">
                      <form action="{{URL::action('ExcelController@AlimentosExcel', ['criterio'=>$criterio])}}" method="get">
