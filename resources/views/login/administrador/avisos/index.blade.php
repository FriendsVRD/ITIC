              ...
              <div class="col-md-12">
                ...
                <div class="container">
                  <div class="card" style="width: 250px;">
                    <img class="card-img-top" src="images_aviso/{{$aviso->archivo_aviso}}"></img>
                    <div class="card-body">
                      <h5 class="card-title">{{$aviso->nombre_aviso}}</h5>

                      <div class="card">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item">Descripción: {{$aviso->descripcion_aviso}}</li>
                          <li class="list-group-item">Tipo: {{$aviso->tipo_aviso}}</li>
                        </ul>
                      </div>
                      <br>
                      <a href="{{URL::action('AvisosController@edit',['$id_avi'=>$aviso->id_aviso])}}" class="btn btn-outline-warning btn-block">Modificar</a>
          ...
          @foreach ($promociones as $promocion)
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="container">
                  <div class="card" style="width: 250px;">
                    <img class="card-img-top" src="images_aviso/{{$promocion->archivo_aviso}}"></img>
                    <div class="card-body">
                      <h5 class="card-title">{{$promocion->nombre_aviso}}</h5>

                      <div class="card">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item">Descripción: {{$promocion->descripcion_aviso}}</li>
                          <li class="list-group-item">Tipo: {{$promocion->tipo_aviso}}</li>
                        </ul>
                      </div>
                      <br>
                      <a href="" class="btn btn-outline-warning btn-block">Modificar</a>
