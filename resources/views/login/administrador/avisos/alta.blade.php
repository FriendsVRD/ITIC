    ...
    <div class="header_top_bar">                   <!--\\\\\\\ header top bar start \\\\\\-->
      ...
      <div class="top_left">
        <div class="top_left_menu">
          <ul>
            ...
            <li class="dropdown"> <a data-toggle="dropdown" href="javascript:void(0);"> <i class="fa fa-th-large"></i> </a> </li>
          </ul>
        </div>
      </div>
      ...
      <div class="top_right_bar">
        <div class="top_right">
          <div class="top_right_menu">
            <ul>
              <li class="dropdown"> <a href="javascript:void(0);" data-toggle="dropdown"> Tasks <span class="badge badge">0</span> </a> </li>
              <li class="dropdown"> <a href="javascript:void(0);" data-toggle="dropdown"> Mail <span class="badge badge color_1">0</span> </a> </li>
      ...
      <div>
          ...
          <ul class="dropdown-menu">
            <div class="top_pointer"></div>
            <li> <a href="{{URL::action('AdministradorController@CerrarSesion')}}"><i class="fa fa-power-off"></i><i class="fa fa-power-off"></i> </i> Logout</a> </li>
          </ul>
      </div> 
      ...
      <div class="left_nav_slidebar">
        <ul>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-home"> </i> INICIO <span class="left_nav_pointer"></span> <span class="plus"> <i class="fa fa-plus"></i></span> </a>
            <ul>  <li> <a href="Index1"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Inicio</b> </a> </li>  </ul>
          </li>
        ...
        <div class="row">
          <div class="col-sm-12 col-sm-12">
             <div class="col-md-12">
                ...
                <div class="header">
                    <h3 class="content-header">Alta Aviso</h3>
                </div>

                  <div class="porlets-content">
                    <form class="form-horizontal group-border-dashed" action="{{route('alta_aviso')}}" method="POST" parsley-validate novalidate enctype="multipart/form-data">
                      {{csrf_field()}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <select name="tipo_aviso">
                            <option value="" disabled="on" selected="on">-Selecciona uno-</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Nombre del Aviso" name="nombre_aviso">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Descripción del Aviso" name="descripcion_aviso">
                        </div>
                      </div><!--/form-group-->
 
                      <div class="form-group">
                        <label id="lb_prom" class="col-sm-3 control-label ">Imagen:</label>
                        <div class="col-sm-3">
                          <input type="file" name="archivo_aviso">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <div class="radio">
                            <label>
                              <input type="radio" value="1" name="activo_aviso">
                              <span class="custom-checkbox"></span>Si</label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="0" name="activo_aviso" required="">
