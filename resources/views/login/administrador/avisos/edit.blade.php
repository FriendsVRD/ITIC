  ...
  <div class="header_bar">
    ...
    <div class="header_top_bar">
      ...
      <div class="top_right_bar">
       ...
       <div class="user_admin dropdown"> <a href="javascript:void(0);" data-toggle="dropdown"><img src="{{asset('images/user.png')}}" /><span class="user_adminname">{{Session::get('sesionname')}}</span> <b class="caret"></b> </a>
          <ul class="dropdown-menu">
            <div class="top_pointer"></div>

            <li> <a href="{{URL::action('AdministradorController@CerrarSesion')}}"><i class="fa fa-power-off"><i class="fa fa-power-off"></i> Logout</a> </li>
          </ul>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12 col-sm-12">
             <div class="col-md-12">
                <div class="block-web">
                  <div class="header">
                    <h3 class="content-header">Modificar Aviso</h3>
                  </div>
                  <div class="porlets-content">
                    <form class="form-horizontal group-border-dashed" action="{{route('modificar_aviso')}}" parsley-validate novalidate method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}

                      <div class="form-group">
                        <label class="col-sm-3 control-label"> </label>
                        <div class="col-sm-6">
                          <input type="hidden" class="form-control" required name="id_aviso" value="{{$avisos->id_aviso}}" readonly="on">
                        </div>
                      </div><!--/form-group-->
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Nombre del Aviso" name="nombre_aviso" value="{{$avisos->nombre_aviso}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Cantidad" name="cantidad_aviso" value="{{$avisos->cantidad_aviso}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Precio" name="costo_aviso" value="{{$avisos->costo_aviso}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <textarea class="form-control" placeholder="Descripción del Aviso" name="descripcion_aviso" value="{{$avisos->descripcion_aviso}}">{{$avisos->descripcion_aviso}}</textarea>
                        </div>
                      </div><!--/form-group--> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <select class="form-control" required name="escala_aviso">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <div class="radio">
                            <label>
                              <input type="radio" value="1" name="activo_aviso" value="{{$avisos->activo_aviso}}">
                              <span class="custom-checkbox"></span>Si</label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="0" name="activo_aviso" value="{{$avisos->activo_aviso}}">
