        ...
        <div class="row">
          <div class="col-sm-12 col-sm-12">
             <div class="col-md-12">
                <div class="block-web">
                  <div class="header">
                    <h3 class="content-header">Modificar Alimento</h3>
                  </div>
                  <div class="porlets-content">
                    <form class="form-horizontal group-border-dashed" action="{{route('modificar_alimento1')}}" parsley-validate novalidate method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}

                      <div class="form-group">
                        <label class="col-sm-3 control-label"> </label>
                        <div class="col-sm-6">
                          <input type="hidden" class="form-control" required name="id_alimento" value="{{$alimentos->id_alimento}}" readonly="on">
                        </div>
                      </div><!--/form-group-->
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Nombre del Alimento" name="nombre_alimento" value="{{$alimentos->nombre_alimento}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Cantidad" name="cantidad_alimento" value="{{$alimentos->cantidad_alimento}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Precio" name="costo_alimento" value="{{$alimentos->costo_alimento}}">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <textarea class="form-control" placeholder="Descripción del Alimento" name="descripcion_alimento" value="{{$alimentos->descripcion_alimento}}">{{$alimentos->descripcion_alimento}}</textarea>
                        </div>
                      </div><!--/form-group--> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <div class="radio">
                            <label>
                              <input type="radio" value="1" name="activo_alimento" value="{{$alimentos->activo_alimento}}">
                              <span class="custom-checkbox"></span>Si</label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="0" name="activo_alimento" value="{{$alimentos->activo_alimento}}">
