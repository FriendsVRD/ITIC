      ...
      <div class="top_right_bar">
       ...
       <div class="user_admin dropdown"> <a href="javascript:void(0);" data-toggle="dropdown"><img src="images/user.png" /><span class="user_adminname">{{Session::get('sesionname')}}</span> <b class="caret"></b> </a>
          <ul class="dropdown-menu">
            ...
            <li> <a href="{{URL::action('AdministradorController@CerrarSesion')}}"><i class="fa fa-power-off"></i> Logout</a> </li>
          </ul>
        </div>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        <section class="panel default blue_title h2">
              ...
              <form method="POST" action="{{route('buscarUsuarios1')}}">
                {{csrf_field()}}
              ...
              <div class="panel-heading center">
                ...
                <div class="panel-body">
                  <div class="col-md-12 default">
                    ...
                    <div class="col-md-6">
                      <form action="{{URL::action('PDFController@UsuariosPDF', ['criterio'=>$criterio])}}" method="get">
                    ...
                    <div class="col-md-6">
                      <form action="{{URL::action('ExcelController@UsuariosExcel', ['criterio'=>$criterio])}}" method="get">
