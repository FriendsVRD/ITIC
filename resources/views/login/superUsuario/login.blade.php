        ...
        <div class="col-md-12">
          <div class="block-web">
            ...
            <div class="porlets-content">
              ...
              <!--Inicia el FORM-->
              <form class="form-horizontal" role="form"  parsley-validate novalidate method="POST" action="{{route('LoginSistema')}}">
                {{csrf_field()}}
                ...
                <div class="form-group">
                  <div class="col-sm-offset-7 col-sm-7">
                    <div class="checkbox">
                      <label><a href="{{URL::action('SuperUsuarioController@IndexRecuperar')}}">Olvide mi contraseña</a></label>
                    </div>
                  </div>
                </div><!--/form-group--> 
