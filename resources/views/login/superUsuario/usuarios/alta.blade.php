        ...
        <div class="row">
          <div class="col-sm-12 col-sm-12">
             <div class="col-md-12">
                <div class="block-web">
                  <div class="header">
                    <h3 class="content-header">Alta Usuario</h3>
                  </div>
                  <div class="porlets-content">
                    <form class="form-horizontal group-border-dashed" action="{{route('alta_user')}}" parsley-validate novalidate method="POST">
                      {{csrf_field()}}

                      <div class="form-group">
                        <label class="col-sm-3 control-label">Nombre:</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Nombre del Usuario" 
                          name="nombre_user">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Direccion del Usuario" 
                          name="direccion_user">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <div class="radio">
                            <label>
                              <input type="radio" value="Mujer" name="sexo_user">
                              <span class="custom-checkbox"></span>Mujer</label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="Hombre" name="sexo_user" required="on">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <div class="radio">
                            <label>
                              <input type="radio" value="SuperUsuario" name="tipo_user">
                              <span class="custom-checkbox"></span>Super Usuario</label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="Administrador" name="tipo_user">
                              <span class="custom-checkbox"></span>Administrador</label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="UsuarioComun" name="tipo_user" required="on">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <input type="password" class="form-control" required parsley-equalto="#pass2" placeholder="Confirma Contraseña" name="password_user">
                        </div>
                      </div><!--/form-group-->
