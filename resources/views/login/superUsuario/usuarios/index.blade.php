      ...
      <div class="left_nav_slidebar">
        <ul>
          <li><a href="javascript:void(0);"><i class="fa fa-home"></i> INICIO <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul>
              <li> <a href="Index"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Inicio</b> </a> </li>
            </ul>
          </li>
          <li> <a href="javascript:void(0);"> <i class="fa fa-edit"></i> PRODUCTOS <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul>
              <li> <a href="Productos"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Detalles</b> </a> </li>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-tasks"></i> ALIMENTOS <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul>
              <li> <a href="Alimentos"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Detalles</b> </a> </li>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> CLIENTES <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul>
              <li> <a href="Clientes"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Detalles</b> </a> </li>
              <li> <a href="AltaCliente"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Nuevo Cliente</b> </a> </li>
            </ul>
          </li>
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-envelope"></i> USUARIOS <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul>
              <li> <a href="Usuarios"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Detalles</b> </a> </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        <section class="panel default blue_title h2">
              ...
              <form method="POST" action="{{route('buscarUsuarios')}}">
                {{csrf_field()}}
                <div class="panel-body">
                  <input type="text" name="criterio" placeholder="Busca aquí..." class="form-control col-md-3"><button type="submit" class="btn btn-info btn-icon"> Buscar <i class="fa fa-search"></i> </button>
                </div>
              </form>
            </section>
      </div>
              ...
              <div class="col-md-12">
                ...
                <div class="container">
                  <div class="card" style="width: 250px;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">{{$user->nombre_user}} {{$user->ap_user}} {{$user->am_user}}</h5>

                      <div class="card">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item"><strong>Dirección:</strong> {{$user->direccion_user}}</li>
                          <li class="list-group-item"><strong>Sexo:</strong> {{$user->sexo_user}}</li>
                          <li class="list-group-item"><strong>Teléfono:</strong> {{$user->telefono_user}}</li>
                          <li class="list-group-item"><strong>Tipo de Usuario:</strong> {{$user->tipo_user}}</li>
                          <li class="list-group-item"><strong>E-mail:</strong> {{$user->email_user}}</li>
                        </ul>
                      </div>
                      <br>
                      <a href="{{URL::action('UsuariosController@edit',['id_usuari'=>$user->id_user])}}" class="btn btn-outline-warning btn-block">Modificar</a>

                      <!--<a href="{{URL::action('UsuariosController@show',['id_usuariou'=>$user->id_user])}}" class="btn btn-outline-danger">Eliminar</a>-->
                    </div>
                  </div>
                </div>
                <!--/block-web-->
