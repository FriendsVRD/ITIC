        ...
        <ul>
          ...
          <li> <a href="javascript:void(0);"> <i class="fa fa-tasks"></i> ALIMENTOS <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul>
              ...
              <li> <a href="AltaCliente"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>Nuevo Alimento</b> </a> </li>
            </ul>
          </li>
        ...
        <div class="row">
          <div class="col-sm-12 col-sm-12">
             <div class="col-md-12">
                <div class="block-web">
                  <div class="header">
                    <h3 class="content-header">Alta Producto</h3>
                  </div>
                  <div class="porlets-content">
                    <form class="form-horizontal group-border-dashed" action="{{route('alta_producto')}}" method="POST" parsley-validate novalidate enctype="multipart/form-data">
                      {{csrf_field()}}

                      <div class="form-group">
                        <label class="col-sm-3 control-label">Nombre:</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Nombre del Producto" name="nombre_producto">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder=" Cantidad Producto" name="cantidad_producto">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Precio del Producto" name="costo_producto">
                        </div>
                      </div><!--/form-group-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="file" required placeholder="Imagen" name="archivo_producto">
                        </div>
                      </div><!--/form-group--> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <div class="radio">
                            <label>
                              <input type="radio" value="1" name="activo_producto">
                              <span class="custom-checkbox"></span>Si</label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="0" name="activo_producto">
