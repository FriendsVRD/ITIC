                ...
                <div class="container">
                  <div class="card" style="width: 250px;">
                    ...
                    <div class="card-body">
                      ...
                      <br>
                      <a href="{{URL::action('ProductosController@edit',['id_product'=>$producto->id_producto])}}" class="btn btn-outline-warning">Modificar</a>
                       
                      <a href="{{URL::action('ProductosController@show',['id_productou'=>$producto->id_producto])}}" class="btn btn-outline-danger">Eliminar</a>
                    </div>
                  </div>
                </div>
                <!--/block-web-->
