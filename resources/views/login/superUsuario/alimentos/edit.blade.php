             ...
             <div class="col-md-12">
                <div class="block-web">
                  ...
                  <div class="porlets-content">
                    <form class="form-horizontal group-border-dashed" action="{{route('modificar_alimento')}}" parsley-validate novalidate method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Tamaño" name="escala_alimento" value="{{$alimentos->escala_alimento}}">
                        </div>
                      </div><!--/form-group--> 
