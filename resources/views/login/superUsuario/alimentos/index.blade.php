    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        <section class="panel default blue_title h2">
              ...
              <form method="POST" action="{{route('buscarAlimentos')}}">
                {{csrf_field()}}
              ...
              <div class="col-md-12">
                ...
                <div class="container">
                  <div class="card" style="width: 250px;">
                    <img class="card-img-top" src="images_alimentos/{{$alimento->archivo_alimento}}"></img>
                    <div class="card-body">
                      <h5 class="card-title">{{$alimento->nombre_alimento}}</h5>

                      <div class="card">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item">Cantidad: {{$alimento->cantidad_alimento}}</li>
                          <li class="list-group-item">Costo: {{$alimento->costo_alimento}}</li>
                          <li class="list-group-item">Descripción: {{$alimento->descripcion_alimento}}</li>
                          <li class="list-group-item">Tamaño: {{$alimento->escala_alimento}}</li>
                        </ul>
                      </div>
                      <br>
                      <a href="{{URL::action('AlimentosController@edit',['id_aliment'=>$alimento->id_alimento])}}" class="btn btn-outline-warning">Modificar</a>

                      <a href="{{URL::action('AlimentosController@show',['id_alimentou'=>$alimento->id_alimento])}}" class="btn btn-outline-danger">Eliminar</a>
                    </div>
                  </div>
                </div>
                <!--/block-web-->
