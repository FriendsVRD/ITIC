             ...
             <div class="col-md-12">
                <div class="block-web">
                  ...
                  <div class="porlets-content">
                    <form class="form-horizontal group-border-dashed" action="{{route('alta_alimento')}}" method="POST" parsley-validate novalidate enctype="multipart/form-data">
                      {{csrf_field()}}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <textarea class="form-control" placeholder="Descripción del Alimento" name="descripcion_alimento"></textarea>
                        </div>
                      </div><!--/form-group--> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" required placeholder="Tamaño" name="escala_alimento">
                        </div>
                      </div><!--/form-group--> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="radio">
                            <label>
                              <input type="radio" value="0" name="activo_alimento">
