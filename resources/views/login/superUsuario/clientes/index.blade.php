    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        <section class="panel default blue_title h2">
              ...
              <form method="POST" action="{{route('buscarClientes')}}">
                {{csrf_field()}}
              ...
              <div class="col-md-12">
                <div class="col-md-12"> 
                  ...
                  <div class="panel-heading">
                    <span class="semi-bold">CLIENTES</span> 
                  </div>
                  <div class="panel-body">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="{{URL::action('ClientesController@edit',['id_client'=>$cliente->id_cliente])}}" class="btn btn-outline-warning">Modificar</a></td>
                          <td><a href="{{URL::action('ClientesController@show',['id_clienteo'=>$cliente->id_cliente])}}" class="btn btn-outline-danger">Eliminar</a></td>
                        </tr>
