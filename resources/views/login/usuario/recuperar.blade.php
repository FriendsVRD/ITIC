        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Recupera tu Contraseña Aquí.</h3>
            </div>
            <div class="porlets-content">

              <!--Inicia el FORM-->
              <form class="form-horizontal" role="form" parsley-validate novalidate method="POST" action="{{route('enviar_password2')}}">
                {{csrf_field()}}
